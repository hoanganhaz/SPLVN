                    ...
                    <nav class="box-navigation text-center">
                        <ul class="box-nav-ul justify-content-start">
                                                ...
                                                <div class="mega-menu-item">
                                                    ...
                                                    <ul class="menu-list">
                                                        ...
                                                        <li><a href="shop-list.html"
                                                                class="menu-link-text text_secondary link">Shop List</a>
                                                        </li>
                                                        <li><a href="shop-full-grid.html"
                                                                class="menu-link-text text_secondary link">Shop Full
                                                                Grid</a></li>
                                                        <li><a href="shop-full-list.html"
                                                                class="menu-link-text text_secondary link">Shop Full
                                                                List</a></li>
                                                        <li><a href="shop-sidebar-left.html"
                                                                class="menu-link-text text_secondary link">Shop Sidebar
                                                                Left</a></li>
                                                ...
                                                <div class="mega-menu-item">
                                                    ...
                                                    <ul class="menu-list">
                                                        <li><a href="product-style-01.html"
                                                                class="menu-link-text text_secondary link">Product Style
                                                                1</a></li>
                                                ...
                                                <div class="mega-menu-item">
                                                    <ul class="menu-list">
                                                        ...
                                                        <li><a href="product-grid-1.html"
                                                                class="menu-link-text text_secondary link">Product Grid
                                                                1</a></li>
                                                ...
                                                <div class="mega-menu-item">
                                                    <ul class="menu-list">
                                                        ...
                                                        <li><a href="product-up-sell.html"
                                                                class="menu-link-text text_secondary link">Product Up
                                                                Sell</a></li>
                                                        <li><a href="product-pre-order.html"
                                                                class="menu-link-text text_secondary link">Product Pre
                                                                Order</a></li>
                                                        <li><a href="product-grouped.html"
                                                                class="menu-link-text text_secondary link">Product
                                                                Grouped</a></li>
                                                        <li><a href="product-out-of-stock.html"
                                                                class="menu-link-text text_secondary link">Product Out
                                                                Of Stock</a></li>
                                                ...
                                                <div class="mega-menu-item">
                                                    <div class="collection-position hover-img style-4">
                                                        <a href="product-detail.html" class="img-style w-100">
                                                            <img class="lazyload"
                                                                data-src="assets/client/images/banner/collections-1.jpg"
                                                                src="assets/client/images/banner/collections-1.jpg" alt="banner-cls">
                                                        </a>
                                                        <div class="content cls-content">
                                                            <h6> <a href="product-detail.html" class="link">Desks</a>
                                                            </h6>
                                                            <h6>25 products</h6>
                                                        </div>
                                                    </div>
                            ...
                            <li class="menu-item position-relative">
                                ...
                                <div class="sub-menu submenu-default">
                                    <ul class="menu-list">
                                        <li><a href="{{ route('client.about') }}" class="menu-link-text">About Us</a>
                                        </li>
        ...
        <div class="swiper-wrapper">
            <div class="swiper-slide">
                <div class="thumbs-item">
                    <div class="image">
                        <img class="lazyload" data-src="assets/client/images/slider/slider-home2-sub1.jpg"
                            src="assets/client/images/slider/slider-home2-sub1.jpg" alt="">
                    </div>
                    <div class="content">
                        ...
                        <a href="#quickView" data-bs-toggle="modal"
                            class="text-button-small link text_white text-decoration">Quick View</a>
                    </div>
                </div>
            </div>
            <div class="swiper-slide">
                <div class="thumbs-item">
                    <div class="image">
                        <img class="lazyload" data-src="assets/client/images/slider/slider-home2-sub2.jpg"
                            src="assets/client/images/slider/slider-home2-sub2.jpg" alt="">
                    </div>
                    <div class="content">
            ...
            <div class="swiper-slide">
                <div class="thumbs-item">
                    <div class="image">
                        <img class="lazyload" data-src="assets/client/images/slider/slider-home2-sub3.jpg"
                            src="assets/client/images/slider/slider-home2-sub3.jpg" alt="">
                    </div>
                    <div class="content">
        ...
        <div class="swiper-wrapper">
            <div class="swiper-slide">
                <div class="wrap-slider">
                    <div class="img-style">
                        <img class="lazyload" data-src="assets/client/images/slider/slider-home2-1.jpg"
                            src="assets/client/images/slider/slider-home2-1.jpg" alt="banner-cls">
                    </div>
            ...
            <div class="swiper-slide">
                <div class="wrap-slider">
                    <div class="img-style">
                        <img class="lazyload" data-src="assets/client/images/slider/slider-home2-2.jpg"
                            src="assets/client/images/slider/slider-home2-2.jpg" alt="banner-cls">
                    </div>
                    <div class="box-content">
                        <div class="box-title">
            ...
            <div class="swiper-slide">
                <div class="wrap-slider">
                    <div class="img-style">
                        <img class="lazyload" data-src="assets/client/images/slider/slider-home2-3.jpg"
                            src="assets/client/images/slider/slider-home2-3.jpg" alt="banner-cls">
                    </div>
                    <div class="box-content">
                        <div class="box-title">
